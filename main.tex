...
\begin{figure}
  \centering
  \includegraphics[width=8cm]{figs/flood-network.pdf}
...
\begin{itemize}
    ...
    \item item different ways to sample positive and negative
\end{itemize}
...
\begin{table}
  ...
  \begin{tabular}{lllll}
    ...
    \midrule
   MSE(Points)$\downarrow$  & 100.86089 &  99.6055  &286.178 &   -   \\
   \midrule
    ARI$\uparrow$     &  0.5967258  & 0.4878859  & - &  0.50066 \\
    \bottomrule
  \end{tabular}
\end{table}
